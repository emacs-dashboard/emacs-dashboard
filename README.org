[[https://circleci.com/gh/emacs-dashboard][https://img.shields.io/circleci/project/emacs-dashboard/emacs-dashboard/master.svg]]
...
Reverse agenda items by setting =dashboard-agenda-reverse= to =t=.
